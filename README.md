...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/patchnetvlad-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12946&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/patchnetvlad-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `patchnetvlad` can be installed with:

```
conda install patchnetvlad
```

It is possible to list all of the versions of `patchnetvlad` available on your platform with:
